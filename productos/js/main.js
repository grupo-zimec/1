...
function documentReadyInit() {
	...
	$('form.contact-form2').on('submit', function( e ){
		...
		//sending form data to PHP server if fields are not empty
		var request = $form.serialize();
		var ajax = jQuery.post( "contact-form2.php", request )
			.done(function( data ) {
				$($form).find('[type="submit"]').attr('disabled', false).parent().append('<div class="contact-form-respond color-main mt-20">'+data+'</div>');
				//cleaning form
				var $formErrors = $form.find('.form-errors');
...
/*
	...
	$('form.contact-form3').on('submit', function( e ){
		...
		//sending form data to PHP server if fields are not empty
		var request = $form.serialize();
		var ajax = jQuery.post( "contact-form3.php", request )
			.done(function( data ) {
				$($form).find('[type="submit"]').attr('disabled', false).parent().append('<div class="contact-form-respond color-main mt-20">'+data+'</div>');
				//cleaning form
				var $formErrors = $form.find('.form-errors');
...
e.preventDefault();
var $form = $(this);
var form = $('.contact-form3')[0]; // aqui mandamos todos los campos que hay en el dormulario y lo recuperamos con el nombre original
